...
class PopAgent(Agent):
    ...
    def update(self, other):
        ...
        if self.belief == Belief.Method_B and other.belief == Belief.Method_A and self.beliefTime > 80 and self.beliefTime < 320:
            self.setBelief(Belief.Method_A)
            
        if self.belief == Belief.Neutral and other.belief == Belief.Method_A and self.beliefTime > 80 and self.beliefTime < 320:
            self.setBelief(Belief.Method_A)

        if self.belief == Belief.Method_A and other.belief == Belief.Method_B  and self.beliefTime > 320:
            self.setBelief(Belief.Method_B)
            
        if self.belief == Belief.Neutral and other.belief == other.belief == Belief.Method_B and self.beliefTime > 320:
            self.setBelief(Belief.Method_B)
