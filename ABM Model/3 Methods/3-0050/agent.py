...
csv_file = 'Highest_PR_Method_20-3P.csv'
...
METHOD_B_TO_METHOD_C_THRESHOLD = get_threshold(df, 'C')
...
class PopAgent(Agent):
    ...
    def update(self, other):
        ...
        if self.belief == Belief.Method_C and other.belief == Belief.Method_A and NEUTRAL_TO_METHOD_A_THRESHOLD < self.beliefTime <= METHOD_A_TO_METHOD_B_THRESHOLD:
            self.setBelief(Belief.Method_A)
        ...
        if self.belief == Belief.Neutral and other.belief == Belief.Method_A and NEUTRAL_TO_METHOD_A_THRESHOLD < self.beliefTime <= METHOD_A_TO_METHOD_B_THRESHOLD:
            self.setBelief(Belief.Method_A)
        if self.belief == Belief.Method_A and other.belief == Belief.Method_B and METHOD_A_TO_METHOD_B_THRESHOLD < self.beliefTime <= METHOD_B_TO_METHOD_C_THRESHOLD:
            self.setBelief(Belief.Method_B)
        if self.belief == Belief.Method_C and other.belief == Belief.Method_B and METHOD_A_TO_METHOD_B_THRESHOLD < self.beliefTime <= METHOD_B_TO_METHOD_C_THRESHOLD:
            self.setBelief(Belief.Method_B)
        if self.belief == Belief.Neutral and other.belief == Belief.Method_B and METHOD_A_TO_METHOD_B_THRESHOLD < self.beliefTime <= METHOD_B_TO_METHOD_C_THRESHOLD:
            self.setBelief(Belief.Method_B)
        if self.belief == Belief.Method_A and other.belief == Belief.Method_C and self.beliefTime > METHOD_B_TO_METHOD_C_THRESHOLD:
            self.setBelief(Belief.Method_C)
        if self.belief == Belief.Method_B and other.belief == Belief.Method_C and self.beliefTime > METHOD_B_TO_METHOD_C_THRESHOLD:
            self.setBelief(Belief.Method_C)
        if self.belief == Belief.Neutral and other.belief == Belief.Method_C and self.beliefTime > METHOD_B_TO_METHOD_C_THRESHOLD:
            self.setBelief(Belief.Method_C)
